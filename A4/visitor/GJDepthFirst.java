  ...
  boolean isMain ;
   ...
   public R visit(Procedure n, A argu) {
      ...
      if(  ((String)argu) == "third")
        {
            id = (String) n.f0.accept(this, (A) "lbl" );
        }
      ...
      {
        //System.out.println("Inside Proc " + id + " " + argc );
      ...
      if(((String)argu) == "third")
      {
        ...
        //st.funcList.get(currFunc).stkCnt
        System.out.print("[" + argc + "] " + "["+ "18" +  "]" + "[" + currFuncBox.maxArg + "]\n");
        this.currFunc =  id ;
   ...
   public R visit(ErrorStmt n, A argu) {
      R _ret=null;
      n.f0.accept(this, argu);
      if( ((String)argu) == "third")System.out.println("ERROR");
      return _ret;
   }
        ...
        */
        if( ((String)argu) == "first")
        {
           //System.out.println("currFunc is : " + currFunc);
            //System.out.println("arg count for " + currFunc + " is " + st.funcList.get(currFunc).argcount );
          ...
          if( ((String)argu) == "third")
          {
            ...
            // System.out.println("arg count for " + currFunc + " is " + currFuncBox.argcount );

              for(int i = 0 ; i < st.funcList.get(currFunc).argcount ; i++  )
              {
                String str1 = st.funcList.get(currFunc).usedRegMap.get(i) ;
                if(str1 == null ) str1 = st.funcList.get(currFunc).regMap.get(i) ;
   ...
   public R visit(Call n, A argu) {
      ...
      if( ! ( ((String)argu) == "first"  || ((String)argu) == "second" || ((String)argu) == "third" ))
      {
        String tmp = (String) n.f1.accept(this, argu);
         int num = Integer.parseInt(tmp) ;
         String str = st.funcList.get(currFunc).usedRegMap.get(num) ;
          ...
          if(argu.equals(str))
          {
            //System.out.println("argu is " + argu + " str is " + str );
            System.out.print(" " + str );
          }
          else System.out.print(" "+argu);
      }
      n.f2.accept(this, argu);
      String args = " ";
    ...
    else
    {
      ...
      {}
        else
        {
            ...
            System.out.println();
            //System.out.println("isMain is " + isMain);
            if(!isMain)
            {
              for(int i=8;i<=17;i++)
              {
                    System.out.println("ASTORE SPILLEDARG "+ i + " "+st.funcList.get(currFunc).regT[i-8]);
              }
            }
            if(isMain)
            {
              for(int i=0;i<=9;i++)
              {
                    System.out.println("ASTORE SPILLEDARG "+ i + " "+st.funcList.get(currFunc).regT[i]);
              }
            }
        ...
        // int num1 = Integer.parseInt(tmp) ;
         ...
         // }
           ...
           if(!isMain)
           {
             ...
             {
                   // ALOAD s0 SPILLEDARG 0
                   System.out.println("ALOAD "+ st.funcList.get(currFunc).regT[i-8] + " SPILLEDARG " +  i );
               }
           }
           if(isMain)
           {
             ...
             {
                   // ALOAD s0 SPILLEDARG 0
                   System.out.println("ALOAD "+ st.funcList.get(currFunc).regT[i] + " SPILLEDARG " +  i );
               }
           }
