...
public class SymbolTable
{
           ...
           public HashMap<String , Integer> classRecordList;
           SymbolTable()
           {
              classList = new HashMap<String , classBox>();
              classRecordList = new HashMap<String, Integer>();
            //  funcVarOrdList = new HashMap<String , Integer>() ;
           }
           ...
           {
             for(Map.Entry <String , Integer> mp : classRecordList.entrySet())
             {
             ...
             for (Map.Entry <String , classBox> mapElement : classList.entrySet())
             {
                 ...
                 if( c != null )
                 {
                   ...
                   for(Map.Entry <Integer,String> cvi : c.funcOrdList.entrySet())
                   {
                      System.out.print( cvi.getKey() + " function order is " + cvi.getValue()+'\n' );
                   }

                   for(Map.Entry <String , Integer> cvi : c.clsVarOrd.entrySet())
                   {
                      System.out.print( (String)cvi.getKey() + " class variable order is  " + (int) cvi.getValue()+'\n' );
                   }
                   for(Map.Entry <String,Integer> fvi : c.funcRevList.entrySet())
                   {

                          System.out.println(fvi.getKey() + " reverse order is " + fvi.getValue()+'\n');
                   ...
                   for(Map.Entry <String , funcBox> fi : c.funcList.entrySet())
                   {
                     ...
                     {
                       System.out.print(fb.paraList.get(i) + " whose parameter order is  " + fb.paraTypeList.get(i) ) ;
                      }
                      System.out.print('\n');
                       ...
                       for(Map.Entry <String , Integer> fvi : fb.funcVarOrdList.entrySet())
                       {

                              System.out.println(fvi.getKey() + " function order is " + fvi.getValue()+'\n');

                       }

                       for(Map.Entry <String , Integer> fvi : fb.funcParList.entrySet())
                       {

                              System.out.println(fvi.getKey() + " Parameter order is " + fvi.getValue()+'\n');
